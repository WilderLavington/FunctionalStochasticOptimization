...
--command='wandb agent --count 500  wilderlavington/FunctionalStochasticOptimization/b89yp1k6' --machine='borg' --time='00-24:00' --account='plai' \
--num=1

# run on ubcml
python sweep_runner.py --directory='/ubc/cs/research/plai-scratch/wlaving/FunctionalStochasticOptimization' \
--command='wandb agent  --count 500  wilderlavington/FunctionalStochasticOptimization/b89yp1k6' --machine='ubcml' --time='00-24:00' --account='ubcml' \
--num=1
