...
# mushrooms dataset
  # batch-size=1
    ...
    --batch_size=25 --y=grad_norm --dataset_name=mushrooms --func_only=1 \
    --max_steps=1000000 --alter_baselines=0 --use_optimal_stepsize=1 \
...
# mushrooms dataset
  ...
  # batch-size=125
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=125 --y=grad_norm --dataset_name=mushrooms \
    --max_steps=100000 --func_only=0 --alter_baselines=0 --use_optimal_stepsize=1 \
  ...
  # batch-size=625
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=625 --y=grad_norm --dataset_name=mushrooms \
    --max_steps=100000 --func_only=0 --alter_baselines=0 --use_optimal_stepsize=1 \
...
# ijcnn dataset
  # batch-size=25
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=25 --y=grad_norm --dataset_name=ijcnn \
    --max_steps=100000 --func_only=0 --alter_baselines=0 --use_optimal_stepsize=1 \
  ...
  # batch-size=125
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=125 --y=grad_norm --dataset_name=ijcnn \
    --max_steps=100000 --func_only=0 --alter_baselines=0 --use_optimal_stepsize=1 \
  ...
  # batch-size=625
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=625 --y=grad_norm --dataset_name=ijcnn \
    --max_steps=100000 --func_only=0 --alter_baselines=0 --use_optimal_stepsize=1 \
...
# mushrooms dataset
  # batch-size=25
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=25 --y=grad_norm --dataset_name=mushrooms --func_only=0 \
  ...
  # batch-size=125
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=125 --y=grad_norm --dataset_name=mushrooms --func_only=0 \
    --max_steps=100000 --func_only=0 --alter_baselines=1 --use_optimal_stepsize=0 \
  ...
  # batch-size=625
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=625 --y=grad_norm --dataset_name=mushrooms --func_only=0 \
    --max_steps=100000 --func_only=0 --alter_baselines=1 --use_optimal_stepsize=0 \
...
# ijcnn dataset
  # batch-size=25
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=25 --y=grad_norm --dataset_name=ijcnn --func_only=0 \
    --max_steps=100000 --func_only=0 --alter_baselines=1 --use_optimal_stepsize=0 \
  ...
  # batch-size=125
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=125 --y=grad_norm --dataset_name=ijcnn --func_only=0 \
    --max_steps=100000 --func_only=0 --alter_baselines=1 --use_optimal_stepsize=0 \
  ...
  # batch-size=625
    # loss = BCE
    python plotting.py --download_data=0 --loss=BCEWithLogitsLoss --x=time_elapsed \
    --batch_size=625 --y=grad_norm --dataset_name=ijcnn --func_only=0 \
    --max_steps=100000 --func_only=0 --alter_baselines=1 --use_optimal_stepsize=0 \
