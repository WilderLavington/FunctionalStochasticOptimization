...
--command='wandb agent --count 25 wilderlavington/FunctionalOptimization/ye5sfejf' --machine='borg' --time='00-24:00' --account='plai' \
--num=1

# run on ubcml
python  sweep_runner.py --directory='/ubc/cs/research/plai-scratch/wlaving/FunctionalStochasticOptimization' \
--command='wandb agent --count 25 wilderlavington/FunctionalOptimization/ye5sfejf' --machine='ubcml' --time='00-24:00' --account='ubcml' \
--num=1
