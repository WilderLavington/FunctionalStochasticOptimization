...
def generate_stoch_figure(wandb_records, fig_name, x="optim_steps", y="avg_loss"):
    ...
    axs[0][0].set_title('SSO-SLS: ', fontsize=22)
    axs[0][1].set_title('SSO-Adagrad: ', fontsize=22)
    plt.subplots_adjust(hspace=1.25)
    plt.rcParams["figure.dpi"] = 100  # 400
    fig.tight_layout()
    # show / save
...
def main():
    ...
    generate_stoch_figure(
        wandb_records, fig_name="other-optim-det", x="optim_steps", y="avg_loss"
    )
