...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 15 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 16 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 17 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 22 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 23 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 24 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 71 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 72 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 73 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 78 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 79 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 80 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 99 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 100 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 101 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 106 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 107 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 108 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 127 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 128 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 129 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 134 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 135 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 136 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 183 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 184 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 185 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 190 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 191 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 192 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 211 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 212 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 213 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 218 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 219 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 220 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 239 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 240 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 241 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 246 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 247 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 248 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 295 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 296 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 297 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 302 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 303 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 304 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 323 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 324 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 325 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 330 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 331 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 332 ] 
then 
    python main.py --min_epochs=500 --algo=Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 351 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 352 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 353 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 358 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 359 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 360 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 407 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 408 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 409 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 414 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 415 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 416 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 435 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 436 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 437 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 442 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 443 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 444 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 463 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 464 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 465 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 470 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 471 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 472 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 519 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 520 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 521 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 526 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 527 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 528 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 547 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 548 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 549 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 554 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 555 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 556 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 575 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 576 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 577 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 582 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 583 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 584 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 631 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 632 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 633 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 638 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 639 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 640 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 659 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 660 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 661 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 666 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 667 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 668 ] 
then 
    python main.py --min_epochs=500 --algo=SGD_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 687 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 688 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 689 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 694 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 695 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 696 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 743 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 744 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 745 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 750 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 751 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 752 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 771 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 772 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 773 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 778 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 779 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 780 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=1 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 799 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 800 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 801 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 806 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 807 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 808 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 855 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 856 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 857 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 862 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 863 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 864 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 883 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 884 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 885 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 890 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 891 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 892 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=2 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 911 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 912 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 913 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 918 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 919 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 920 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=5 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 967 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 968 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 969 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 974 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 975 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 976 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=125 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 995 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 996 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 997 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=100 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
...
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-3.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 1002 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-2.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 1003 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=-1.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
if [ $SLURM_ARRAY_TASK_ID -eq 1004 ] 
then 
    python main.py --min_epochs=500 --algo=Diag_Ada_FMDOpt --normalize_epochs_lengths=1 --seed=3 --fullbatch=0 --label=workshop-fig7 --batch_size=625 --m=1000 --use_optimal_stepsize=0 --log_lr=0.0 --loss=MSELoss --dataset_name=mfac --eta_schedule=constant --group=AIstats_narval --log_dir=./wandb./configs/aistats/mfac/gridsearch/minibatch/funcopt.yaml 
fi 
